...
The spectral bisection is the most expensive portion of computation for the 
...
node in the graph, $k$ is the number of vertices in the final graph, and $NNz$
...
$\frac{d}{p}\left(m+3\right) + \log(m)$  \\ \hline
        ...
        Spectral Bisection & $\mathcal{O}(2k)$ & $\mathcal{O}(2k)$  \\ \hline
